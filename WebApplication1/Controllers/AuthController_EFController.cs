...
namespace EmployeeAPI.Controllers
{
    ...
    [ApiController]
    public class AuthController_EFController : ControllerBase
    {
        private readonly IEmployeeService _service;
        private readonly IConfiguration _configuration;

        public AuthController_EFController(
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest req)
        {
            ...
            var user = await _service.Login(req.Username, req.Password);
        ...
        public async Task<IActionResult> Register([FromBody] Employee emp)
        {
            ...
            bool result = await _service.Register(emp);
